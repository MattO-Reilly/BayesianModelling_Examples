...
```{r}
# mean centre the grads and studytime 
...
```{r}
plot(grades_sim_mult[[1]][,1], density = FALSE, main = "a")
plot(grades_sim_mult[[1]][,2], density = FALSE, main = "c")
plot(grades_sim_mult[[1]][,3], density = FALSE, main = "d")
plot(grades_sim_mult[[1]][,4], density = FALSE, main = "s")
```
